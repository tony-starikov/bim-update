...
@section('main')
    ...
    <div class="container-fluid d-none d-xxl-block mt-5" style="background: url(/images/{{ $post->bg_image }}) no-repeat center center local; background-size: cover; height: 50vh;">
    </div>

    <div class="container-fluid d-none d-xl-block d-xxl-none mt-5" style="background: url(/images/{{ $post->bg_image }}) no-repeat center center local; background-size: cover; height: 50vh;">
    </div>

    <div class="container-fluid d-none d-lg-block d-xl-none mt-5" style="background: url(/images/{{ $post->bg_image }}) no-repeat center center local; background-size: cover; height: 50vh;">
    </div>

    <div class="container-fluid d-none d-md-block d-lg-none" style="background: url(/images/{{ $post->image }}) no-repeat center center local; background-size: cover;">
