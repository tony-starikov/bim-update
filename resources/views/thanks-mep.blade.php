            ...
            <div class="row px-lg-5 mt-5">
                <div class="col-12">
                    <div class="row row-cols-1 row-cols-lg-2 g-5">
                        ...
                        <div class="col">
                            <div class="card border border-0 bg-transparent h-100">
                                <img src="/images/Denis.png" alt="thanks scan to bim" class="card-img-top img-fluid w-50 mx-auto">
                                <div class="card-body border border-0">
                                    <h5 class="text-white fw-bold mt-4">
                                        Do you still have questions?
                                    </h5>
                                    <h5 class="text-white fw-semibold">
                                        Contact Denys Moshenskyi, director of MEP Coordination & Digital Fabrication.
                                    </h5>
                                    <a href="mailto:m.denis@bim-prove.com" class="text-decoration-underline text-white">
                                        <h5 class="text-white fw-semibold mt-4">
                                            Email: m.denis@bim-prove.com
                                        </h5>
                                    </a>
                                    <a class="text-decoration-underline text-white" href="https://www.linkedin.com/in/denys-moshenskyi/" target="_blank">
                                        <h5 class="text-white fw-semibold">
                                            Linkedin: Denys Moshenskyi
                                        </h5>
                                    </a>
                                </div>
                                <div class="card-footer border border-0 bg-transparent">
                                    <div class="row p-2 mt-3 d-flex justify-content-center">
                                        <div class="col-12 col-md-10 col-lg-12 col-xxl-9 mx-auto">
                                            <a id="button-first-screen-xxl" href="/service/mep-bim-coordination" role="button" class="btn btn-primary shadow-sm btn-lg border-0 rounded-4 w-100 text-center button-first-screen-xxl" style="background-color: #6bdcdb">
                                                <span class="fw-bold text-uppercase h5 d-block my-2">MEP SERVICES</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
