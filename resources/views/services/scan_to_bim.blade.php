...
@section('main')
    ...
    <div id="main">
        <div class="container-fluid d-none d-xl-block" style="background: url('/images/service/scan_to_bim_images/background2.png') no-repeat center center local; background-size: cover;">
        ...
        <div class="container-fluid d-none d-lg-block d-xl-none" style="background: url('/images/service/scan_to_bim_images/background2.png') no-repeat center center local; background-size: cover;">
            <div class="container mt-5 p-5">
                <div class="row px-5 mt-3 text-center">
                    <div class="col-12 mt-3 order-first">
                        <h2 class="fw-bold mt-3 h1">
                            THE INDIVIDUAL<br>FIVE-STAR
                        </h2>
                        <h2 class="fw-bold text-white mt-3 h1">
                            SCAN TO BIM SERVICE
                        </h2>
                    </div>
                </div>
                ...
                <div class="row px-5 pb-5">
                    <div class="col-3 p-5 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon1.png" alt="icon1" class="img-fluid w-100">
                        <h6 class="text-white fw-semibold mt-4">
                            DIGITAL TWINS
                        </h6>
                    </div>
                    <div class="col-3 p-5 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon2.png" alt="icon2" class="img-fluid w-100">
                        <h6 class="text-white fw-semibold mt-4">
                            REALITY CAPTURE
                        </h6>
                    </div>
                    <div class="col-3 p-5 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon3.png" alt="icon3" class="img-fluid w-100">
                        <h6 class="text-white fw-semibold mt-4">
                            FACILITY MANAGEMENT
                        </h6>
                    </div>
                    <div class="col-3 p-5 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon4.png" alt="icon4" class="img-fluid w-100">
                        <h6 class="text-white fw-semibold mt-4">
                            AS-BUILT
                        </h6>
                    </div>
        ...
        <div class="container-fluid d-none d-md-block d-lg-none" style="background: url('/images/service/scan_to_bim_images/background2.png') no-repeat center center local; background-size: cover;">
            <div class="container mt-5 py-5 pb-0 px-0">
                ...
                <div class="row px-5 pb-5">
                    <div class="col-6 p-3 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon1.png" alt="icon1" class="img-fluid w-50">
                        <h6 class="text-white fw-semibold mt-4">
                            DIGITAL TWINS
                        </h6>
                    </div>
                    <div class="col-6 p-3 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon2.png" alt="icon2" class="img-fluid w-50">
                        <h6 class="text-white fw-semibold mt-4">
                            REALITY CAPTURE
                        </h6>
                    </div>
                    <div class="col-6 p-3 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon3.png" alt="icon3" class="img-fluid w-50">
                        <h6 class="text-white fw-semibold mt-4">
                            FACILITY MANAGEMENT
                        </h6>
                    </div>
                    <div class="col-6 p-3 text-center">
                        <img src="/images/service/scan_to_bim_images/icons/icon4.png" alt="icon4" class="img-fluid w-50">
                        <h6 class="text-white fw-semibold mt-4">
                            AS-BUILT
                        </h6>
                    </div>
        ...
        <div class="container-fluid d-md-none" style="background: url('/images/service/scan_to_bim_images/background2.png') no-repeat center center local; background-size: cover;">
            <div class="container mt-5 py-5 pb-0 px-0">
                <div class="row px-0 mt-3 text-center">
                    <div class="col-12 mt-3 order-first">
                        <h2 class="fw-bold mt-3 h2">
                    ...
                    <div class="row mt-4">
                            ...
                            <div class="row p-2 py-4 h-100" style="border: 4px solid; border-color: #6ad9d8;">
                                <div class="col-12">
                                    <div class="text-center">
                                        <img src="/images/service/scan_to_bim_images/proposes/service1.png" alt="service1" class="img-fluid w-50 mx-auto">
                                    </div>
                                    <h5 class="fw-bold mt-4">
                                        As-built model
                                    </h5>
                        ...
                        <div class="col-4 p-4 pb-0">
                            <div class="row p-2 py-4 h-100" style="border: 4px solid; border-color: #6ad9d8;">
                                <div class="col-12">
                                    <div class="text-center">
                                        <img src="/images/service/scan_to_bim_images/proposes/service2.png" alt="service1" class="img-fluid w-50 mx-auto">
                                    </div>
                                    <h5 class="fw-bold mt-4">
                                        As-built drawings
                                    </h5>
                        ...
                        <div class="col-4 p-4 pb-0">
                            <div class="row p-2 py-4 h-100" style="border: 4px solid; border-color: #6ad9d8;">
                                <div class="col-12">
                                    <div class="text-center">
                                        <img src="/images/service/scan_to_bim_images/proposes/service3.png" alt="service1" class="img-fluid w-50 mx-auto">
                                    </div>
                                    <h5 class="fw-bold mt-4">
                                        Engineering portals
                                    </h5>
                        ...
                        <div class="col-4 p-4 pb-0">
                            <div class="row p-2 py-4 h-100" style="border: 4px solid; border-color: #6ad9d8;">
                                <div class="col-12">
                                    <div class="text-center">
                                        <img src="/images/service/scan_to_bim_images/proposes/service4.png" alt="service1" class="img-fluid w-50 mx-auto">
                                    </div>
                                    <h5 class="fw-bold mt-4">
                                        Anomalies
                                    </h5>
                        ...
                        <div class="col-4 p-4 pb-0">
                            <div class="row p-2 py-4 h-100" style="border: 4px solid; border-color: #6ad9d8;">
                                <div class="col-12">
                                    <div class="text-center">
                                        <img src="/images/service/scan_to_bim_images/proposes/service5.png" alt="service1" class="img-fluid w-50 mx-auto">
                                    </div>
                                    <h5 class="fw-bold mt-4">
                                        Exception reports
                                    </h5>
                        ...
                        <div class="col-4 p-4 pb-0">
                            <div class="row p-2 py-4 h-100" style="border: 4px solid; border-color: #6ad9d8;">
                                <div class="col-12">
                                    <div class="text-center">
                                        <img src="/images/service/scan_to_bim_images/proposes/service6.png" alt="service1" class="img-fluid w-50 mx-auto">
                                    </div>
                                    <h5 class="fw-bold mt-4">
                                        QA\QC
                                    </h5>
