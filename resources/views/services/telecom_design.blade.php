...
@section('main')
    ...
    <div id="main">
        <div class="container-fluid d-none d-xl-block" style="background: url('/images/service/telecom_design_images/header/header.png') no-repeat center center local; background-size: cover;">
            <div class="container mt-5 p-5">
                ...
                <div class="row px-5 pb-4 mt-5 text-center justify-content-center">
                    <div class="col-4">
                        <a href="#PROPOSE" role="button" class="btn btn-primary shadow-lg btn-lg border-0 rounded-4 w-100 px-0" style="background-color: #43aeb6">
                ...
                <div class="row px-5 pb-5 justify-content-center">
                    <div class="col-3 p-5 text-center">
                        <img src="/images/service/telecom_design_images/header/icons/icon1.png" alt="icon1" class="img-fluid w-75">
                        <h6 class="text-white small fw-semibold mt-4">
                            CAD DRAWINGS
                        </h6>
                    </div>
                    <div class="col-3 p-5 text-center">
                        <img src="/images/service/telecom_design_images/header/icons/icon2.png" alt="icon2" class="img-fluid w-75">
                        <h6 class="text-white small fw-semibold mt-4">
                            STEEL STRUCTURE DESIGN SOLUTIONS
                        </h6>
                    </div>
                    <div class="col-3 p-5 text-center">
                        <img src="/images/service/telecom_design_images/header/icons/icon3.png" alt="icon3" class="img-fluid w-75">
                        <h6 class="text-white small fw-semibold mt-4">
        ...
        <div class="container-fluid d-none d-lg-block d-xl-none" style="background: url('/images/service/telecom_design_images/header/header.png') no-repeat center center local; background-size: cover;">
            <div class="container mt-5 p-5 pb-0">
                ...
                <div class="row px-5 pb-4 mt-4 text-center justify-content-center">
                    <div class="col-9">
                        <a href="#PROPOSE" role="button" class="btn btn-primary shadow-lg btn-lg border-0 rounded-4 w-50" style="background-color: #43aeb6">
                ...
                <div class="row px-5 pb-5 justify-content-center">
                    <div class="col-3 py-5 px-0 text-center">
                        <img src="/images/service/telecom_design_images/header/icons/icon1.png" alt="icon1" class="img-fluid w-50">
                        <h6 class="text-white small fw-semibold mt-4 px-2">
                            CAD DRAWINGS
                        </h6>
                    </div>
                    <div class="col-3 py-5 px-0 text-center">
                        <img src="/images/service/telecom_design_images/header/icons/icon2.png" alt="icon2" class="img-fluid w-50">
                        <h6 class="text-white small fw-semibold mt-4 px-2">
                            STEEL STRUCTURE DESIGN SOLUTIONS
                        </h6>
                    </div>
                    <div class="col-3 py-5 px-0 text-center">
                        <img src="/images/service/telecom_design_images/header/icons/icon3.png" alt="icon3" class="img-fluid w-50">
                        <h6 class="text-white small fw-semibold mt-4 px-2">
                            DIGITAL TWINS CREATION
                        </h6>
                    </div>
        ...
        <div class="container-fluid d-none d-md-block d-lg-none" style="background: url('/images/service/telecom_design_images/header/header.png') no-repeat center center local; background-size: cover;">
            <div class="container mt-5 py-5 pb-0 px-0">
                ...
                <div class="row px-5 pb-5">
                    ...
                    <div class="col-6 p-3 text-center mx-auto">
                        <img src="/images/service/telecom_design_images/header/icons/icon3.png" alt="icon3" class="img-fluid w-50">
                        <h6 class="text-white fw-semibold mt-4">
                            DIGITAL TWINS CREATION
                        </h6>
        ...
        <div class="container-fluid d-md-none" style="background: url('/images/service/telecom_design_images/header/header.png') no-repeat center center local; background-size: cover;">
            <div class="container mt-5 py-5 pb-0 px-0">
                <div class="row px-0 mt-3 text-center">
                    <div class="col-12 mt-3 order-first">
                        <h2 class="fw-bold mt-3 h2">
                ...
                <div class="row px-2 pb-4 mt-4 text-center">
                    <div class="col-12">
                        <a href="#PROPOSE" role="button" class="btn btn-primary shadow-lg btn-lg border-0 rounded-4 w-75" style="background-color: #43aeb6">
                            <span class="fw-bold h6 d-block my-2">OUR SERVICES</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="row p-5">
                    ...
                    <div class="col-4">
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/revit_autodesk.png" alt="arrow" class="images-fluid w-100">
                            </div>
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/autocad.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Autodesk AutoCAD
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/advanced_steel.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Advance Steel
                    ...
                    <div class="col-4">
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/rhino.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Rhinoceros
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/navisworks.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Autodesk Navisworks
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/graphisoft.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Graphisoft Arhicad
                    ...
                    <div class="col-4">
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/sketchup.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Sketchup
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/lumion.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Lumion
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/revit_recap.png" alt="arrow" class="images-fluid w-100">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Autodesk ReCap
            ...
            <div class="container py-5">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/revit_autodesk.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Autodesk Revit
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/autocad.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Autodesk AutoCAD
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/advanced_steel.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Advance Steel
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/rhino.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Rhinoceros
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/navisworks.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Autodesk Navisworks
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/sketchup.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Sketchup
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/lumion.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Lumion
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/revit_recap.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Autodesk ReCap
                        ...
                        <div class="row mt-4 d-flex align-items-center">
                            <div class="col-3">
                                <img src="/images/service/telecom_design_images/software/graphisoft.png" alt="arrow" class="images-fluid w-75">
                            </div>
                            <div class="col-9 px-0 d-flex align-items-center">
                                <h5 class="fw-bold m-0">
                                    Graphisoft Arhicad
    ...
    <div id="PROPOSE">
        <div class="d-none d-xl-block">
            <div class="container-fluid" style="background: url('/images/service/telecom_design_images/services/cad_drawings/background.png') no-repeat center center local; background-size: cover;">
                <div class="container p-5">
                    <div class="row p-5">
                        <div class="col-12">
                            <h2 class="fw-bold display-5">
                        ...
                        <div class="col-12 mt-5">
                            <div class="row">
                                ...
                                <div class="col-6 d-flex align-items-center">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="/images/service/telecom_design_images/services/cad_drawings/draft.png" alt="draft" class="img-fluid w-100">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container px-5">
                    <div class="row px-5">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/services/steel/frame.png" alt="draft" class="img-fluid h-100">
                                </div>
                                <div class="col-6 d-flex align-items-center">
                                    <div class="row">
                                        <div class="col-12">
            ...
            <div class="container-fluid" style="background: url('/images/service/telecom_design_images/services/twin/twin.png') no-repeat center center local; background-size: cover;">
                    ...
                    <div class="row px-5">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/services/twin/draft.png" alt="draft" class="img-fluid w-100">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 mt-2">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center">
                                    <img src="/images/service/telecom_design_images/services/cad_drawings/draft.png" alt="draft" class="img-fluid w-75 mx-auto">
                                </div>
                ...
                <div class="container py-5">
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center">
                                    <img src="/images/service/telecom_design_images/services/steel/frame.png" alt="draft" class="img-fluid w-75 mx-auto">
                                </div>
                                <div class="col-12 d-flex align-items-center">
                                    <div class="row">
                                        <div class="col-12">
                ...
                <div class="container py-5">
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12 d-flex align-items-center">
                                    <img src="/images/service/telecom_design_images/services/twin/draft.png" alt="draft" class="img-fluid w-75 mx-auto">
                                </div>
                                <div class="col-12 d-flex align-items-center">
                                    <div class="row">
                                        <div class="col-12">
                ...
                <div class="container p-5">
                    <div class="row p-5">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/rooftop/draft1.png" alt="draft" class="img-fluid w-100">
                                </div>
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/rooftop/draft2.png" alt="draft" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/rooftop/draft3.png" alt="draft" class="img-fluid w-100">
                                </div>
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/rooftop/draft4.png" alt="draft" class="img-fluid w-100">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/tower/draft1.png" alt="draft" class="img-fluid w-100">
                                </div>
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/tower/draft2.png" alt="draft" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/tower/draft3.png" alt="draft" class="img-fluid w-100">
                                </div>
                                <div class="col-6">
                                    <img src="/images/service/telecom_design_images/tower/draft4.png" alt="draft" class="img-fluid w-100">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mt-4">
