...
@section('main')
    ...
    <div id="estimation1" class="container-fluid container-fluid d-none d-xl-block" style="background-color: #bacacd">
        <div class="container px-0 p-lg-5">
                    ...
                    <form method="post" class="footer-form text-white" enctype="multipart/form-data" action="{{route('estimatesProcessingMep')}}">
                        ...
                        <div class="form-check d-flex align-items-center mb-3">
                            <input
                                ...
                                value="HVAC" @if(is_array(old('services')) && in_array('Modeling', old('services'))) checked @endif
                                id="services1"
                                style="width: 30px; height: 30px;"
                            >
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check d-flex align-items-center mb-3">
                                    <input class="form-check-input fw-bold border border-4 border-white shadow-none" type="radio" name="lod5" value="Other" {{ (old('lod') == 'Other' ) ? 'checked' : '' }} id="lod5" style="width: 30px; height: 30px;">
                        ...
                        <div class="form-check d-flex align-items-center mb-3">
                            <input
                                class="form-check-input fw-bold border border-4 border-white shadow-none"
                                type="checkbox"
                                name="coordination_software[]"
                                value="Navisworks"
                                @if(is_array(old('coordination_software')) && in_array('Navisworks', old('coordination_software'))) checked @endif
                                id="coordination_software1"
                                style="width: 30px; height: 30px;"
                            >
                            <label class="form-check-label fw-bold ms-1 mt-2 h5" for="coordination_software1">
                                Navisworks
                            </label>
                        </div>
                        ...
                        <div class="form-check d-flex align-items-center mb-3">
                            <input
                                ...
                                name="coordination_software[]"
                                value="BIM Track"
                                @if(is_array(old('coordination_software')) && in_array('BIM Track', old('coordination_software'))) checked @endif
                                id="coordination_software2"
                                style="width: 30px; height: 30px;"
                            >
                            <label class="form-check-label fw-bold ms-1 mt-2 h5" for="coordination_software2">
                                BIM Track
                            </label>
                        </div>
                        ...
                        <div class="form-check d-flex align-items-center mb-3">
                            <input
                                ...
                                name="coordination_software[]"
                                value="Revizto"
                                @if(is_array(old('coordination_software')) && in_array('Revizto', old('coordination_software'))) checked @endif
                                id="coordination_software3"
                                style="width: 30px; height: 30px;"
                            >
                            <label class="form-check-label fw-bold ms-1 mt-2 h5" for="coordination_software3">
                                Revizto
                            </label>
                        </div>
                        ...
                        <div class="form-check d-flex align-items-center mb-3">
                            <input
                                ...
                                name="coordination_software[]"
                                value="Solibri"
                                @if(is_array(old('coordination_software')) && in_array('Solibri', old('coordination_software'))) checked @endif
                                id="coordination_software4"
                                style="width: 30px; height: 30px;"
                            >
                            <label class="form-check-label fw-bold ms-1 mt-2 h5" for="coordination_software4">
                                Solibri
                            </label>
                        </div>
                            ...
                            <div class="col-3">
                                <div class="form-check d-flex align-items-center mb-3">
                                    <input
                                        ...
                                        type="checkbox"
                                        name="coordination_software[]"
                                        value="Other" @if(is_array(old('coordination_software')) && in_array('Other', old('coordination_software'))) checked @endif
                                        id="coordination_software10"
                                        style="width: 30px; height: 30px;"
                                    >
                                    <label class="form-check-label fw-bold ms-1 mt-2 h5" for="coordination_software10">
                                        Other
                                    </label>
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="mb-3">
                                    <input
                                        ...
                                        type="text"
                                        name="coordination_software-other"
                                        value="{{old('coordination_software-other', '')}}"
    ...
    <div id="estimation2" class="container-fluid d-none d-lg-block d-xl-none" style="background-color: #bacacd">
        <div class="container px-0 p-lg-5">
    ...
    <div id="estimation3" class="container-fluid d-none d-md-block d-lg-none" style="background-color: #bacacd">
    ...
    <div id="estimation4" class="container-fluid d-md-none" style="background-color: #bacacd">
        <div class="container py-5">
            <div class="row">
                <div class="col-12">
