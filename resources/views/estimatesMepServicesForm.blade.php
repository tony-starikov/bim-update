                    ...
                    <div class="row">
                        <div class="col-6 px-0 mt-5">
                            <a href="{{ route('showService', 'mep-coordination') }}" role="button" class="btn btn-primary shadow-lg btn-lg border-0 rounded-4 w-100 text-center" style="background-color: #43aeb6">
                                <span class="fw-bold h4 d-block my-2">MEP COORDINATION & DIGITAL FABRICATION SERVICE</span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row px-0 px-lg-5 my-0">
                ...
                <div class="col-12 my-3">
                    ...
                    <div class="row">
                        <div class="col-6 px-0 mt-5">
                            <a href="{{ route('showService', 'mep-coordination') }}" role="button" class="btn btn-primary shadow-lg btn-lg border-0 rounded-4 w-100 text-center" style="background-color: #43aeb6">
                                <span class="fw-bold h6 d-block my-2">MEP COORDINATION & DIGITAL FABRICATION SERVICE</span>
                            </a>
                        </div>
                    </div>
                </div>
