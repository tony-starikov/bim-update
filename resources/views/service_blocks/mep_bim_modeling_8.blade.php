                ...
                <div class="row">
                        ...
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_1')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_2')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_3')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_4')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_5')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                ...
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_6')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                <div class="col-2 p-0" style="background-color: #6ad9d8;">
                                    <img src="{{ '/images/' . $block->items->where('name', 'item_image_7')->first()->value }}" loading="lazy" alt="arrow" class="images-fluid w-100">
                                </div>
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_7')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                <div class="col-2 p-0" style="background-color: #6ad9d8;">
                                    <img src="{{ '/images/' . $block->items->where('name', 'item_image_8')->first()->value }}" loading="lazy" alt="arrow" class="images-fluid w-100">
                                </div>
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_8')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4 mb-4">
                        <div class="card h-100" style="border: 4px solid #6de0de">
                            <div class="card-body p-0 d-flex align-items-center">
                                <div class="col-2 p-0" style="background-color: #6ad9d8;">
                                    <img src="{{ '/images/' . $block->items->where('name', 'item_image_9')->first()->value }}" loading="lazy" alt="arrow" class="images-fluid w-100">
                                </div>
                                <div class="col-10 p-3 d-flex align-items-center">
                                    <h3 class="h5 m-0">{{ $block->items->where('name', 'item_text_9')->first()->value }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
