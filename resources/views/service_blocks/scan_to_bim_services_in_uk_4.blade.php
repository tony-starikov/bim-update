        ...
        <div class="row p-lg-5">
            ...
            <div class="col-12">
                <div class="row mt-lg-4">
                    ...
                    @endif
                        <div class="col-md-6 col-xl-4 p-4 pb-0">
                            <div class="row py-4 p-5 align-items-center h-100" style="border: 4px solid; border-color: #6ad9d8;">
                                <div class="col-12 text-center mb-4 mb-md-0">
                                    <h3 class="h4 fw-bold">{{ $block->items->where('name', 'last_item_header')->first()->value }}</h3>
                                </div>
                                <div class="col-12">
                                    <a href="{{ $block->items->where('name', 'button_url')->first()->value }}" role="button" class="btn btn-primary shadow-{{ $block->items->where('name', 'button_shadow')->first()->value }} btn-lg border-0 rounded-4 w-100 p-3" style="background-color: {{ $block->items->where('name', 'button_color')->first()->value }}">
