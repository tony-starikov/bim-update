...
class FamilySeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('families')->insert([
            ...
            [
                'title_en' => 'Acoustic suspension for noise reduction Alpha',
                'slug' => 'Acoustic suspension for noise reduction Alpha',
                'description_en' => "",
                'image' => 'families/Acoustic suspension for noise reduction Alpha BIMPROVE.jpg',
                'file' => 'families/Acoustic suspension for noise reduction Alpha BIMPROVE.zip',
            ],
            [
                'title_en' => 'Bathroom faucet',
                'slug' => 'Bathroom faucet',
                'description_en' => "",
                'image' => 'families/Bathroom faucet.jpg',
                'file' => 'families/Bathroom faucet.zip',
            ],
            [
                'title_en' => 'Firstlane turnstile',
                'slug' => 'Firstlane turnstile',
                'description_en' => "",
                'image' => 'families/Firstlane turnstile.jpg',
                'file' => 'families/Firstlane turnstile.zip',
            ],
            [
                'title_en' => 'Hose Reel',
                'slug' => 'Hose Reel',
                'description_en' => "",
                'image' => 'families/Hose Reel.jpg',
                'file' => 'families/Hose Reel.zip',
            ],
            [
                'title_en' => 'Interior Spotlight',
                'slug' => 'Interior Spotlight',
                'description_en' => "",
                'image' => 'families/Interior Spotlight.jpg',
                'file' => 'families/Interior Spotlight.zip',
            ],
            [
                'title_en' => 'Landscape racks mounting system',
                'slug' => 'Landscape racks mounting system',
                'description_en' => "",
                'image' => 'families/Landscape racks mounting system.jpg',
                'file' => 'families/Landscape racks mounting system.zip',
            ],
            [
                'title_en' => 'Loading dock system',
                'slug' => 'Loading dock system',
                'description_en' => "",
                'image' => 'families/Loading dock system.jpg',
                'file' => 'families/Loading dock system.zip',
            ],
            [
                'title_en' => 'Mixer for freestanding bathtub',
                'slug' => 'Mixer for freestanding bathtub',
                'description_en' => "",
                'image' => 'families/Mixer for freestanding bathtub.jpg',
                'file' => 'families/Mixer for freestanding bathtub.zip',
            ],
            [
                'title_en' => 'Pendant Stadium LED 1500',
                'slug' => 'Pendant Stadium LED 1500',
                'description_en' => "",
                'image' => 'families/Pendant Stadium LED 1500.jpg',
                'file' => 'families/Pendant Stadium LED 1500.zip',
            ],
            [
                'title_en' => 'RexRack solar mounting system',
                'slug' => 'RexRack solar mounting system',
                'description_en' => "",
                'image' => 'families/RexRack solar mounting system.jpg',
                'file' => 'families/RexRack solar mounting system.zip',
            ],
            [
                'title_en' => 'Washbasin mixer',
                'slug' => 'Washbasin mixer',
                'description_en' => "",
