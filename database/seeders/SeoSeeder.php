    ...
    public function run(): void
    {
        DB::table('seo')->insert([
            [
                ...
                'description' => "Unlock your AEC company is full potential with our customized BIM support, delivering a five-star service experience tailored specifically for you.",
                'keywords' => 'Keywords',
                'text' => '',
            ],
            [
            ...
            [
                'id' => 6,
                'url' => '/mep-estimates-project',
                'title' => 'MEP coordination | BIM-Estimates for your project',
                'description' => "Assessment of your MEP BIM project from the specialists of BIMprove LLC. The Individual Five-Star Service. Shop Drawings | Coordination | Fabrication",
                'keywords' => 'Keywords',
                'text' => '',
            ],
            [
            ...
            [
                ...
                'description' => "In this article, lets break down the options for working at Revit and go through them in detail.",
                'keywords' => 'Keywords',
                'text' => '',
            ],
            [
            ...
            [
                ...
                'description' => "This quick guide provides insight into BIM, its work, and why it is vital to manufacturers and designers.",
                'keywords' => 'Keywords',
                'text' => '',
            ],
//            [
